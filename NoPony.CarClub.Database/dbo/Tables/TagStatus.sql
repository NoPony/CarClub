...
(
    ...
    [Updated]                   BIT                         NOT NULL        CONSTRAINT [DF_TagStatus_Updated] DEFAULT (0),
    [UpdatedIp]                 VARBINARY(16)               NULL,
    [UpdatedUtc]                DATETIMEOFFSET              NULL,
    [UpdatedUserId]             BIGINT                      NULL,

    [Deleted]                   BIT                         NOT NULL        CONSTRAINT [DF_TagStatus_Deleted] DEFAULT (0),
    [DeletedIp]                 VARBINARY(16)               NULL,
    [DeletedUtc]                DATETIMEOFFSET              NULL,
    [DeletedUserId]             BIGINT                      NULL,

    CONSTRAINT [PK_TagStatus] PRIMARY KEY CLUSTERED ([Id]),
...
CREATE INDEX [IX_Composite] ON [dbo].[TagStatus] ([Deleted] ASC, [Code] ASC) INCLUDE ([Title], [Updated]);
