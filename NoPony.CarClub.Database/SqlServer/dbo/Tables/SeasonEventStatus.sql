CREATE TABLE [dbo].[SeasonEventStatus]
(
    ...
    [Updated]                   BIT                         NOT NULL        CONSTRAINT [DF_SeasonEventStatus_Updated] DEFAULT (0),
    [UpdatedIp]                 VARBINARY(16)               NULL,
    [UpdatedUtc]                DATETIMEOFFSET              NULL,
    [UpdatedUserId]             BIGINT                      NULL,

    [Deleted]                   BIT                         NOT NULL        CONSTRAINT [DF_SeasonEventStatus_Deleted] DEFAULT (0),
    [DeletedIp]                 VARBINARY(16)               NULL,
    [DeletedUtc]                DATETIMEOFFSET              NULL,
    [DeletedUserId]             BIGINT                      NULL,

    CONSTRAINT [PK_SeasonEventStatus] PRIMARY KEY CLUSTERED ([Id]),
